...
def test_fever_adapter():
    ...
    sample = {
        ...
        "label": "SUPPORTS",
        "evidence": [[[101, 1001, "Barack_Obama", 0], [101, 1002, "Barack_Obama", 1]]],
    }
...
def test_multi_evidence_coherence():
    ...
    print(
        f"  Coherence difference: {full_result['overall_coherence'] - partial_result['overall_coherence']:+.3f}"
    )

    return {
        "full_evidence": full_result,
        "partial_evidence": partial_result,
        "coherence_improvement": full_result["overall_coherence"]
        - partial_result["overall_coherence"],
    }
...
def main():
    ...
    print("-" * 40)
    print(
        f"✅ FEVER Adapter: Successfully extracted {len(prop_set.propositions)} propositions"
    )
    print(
        f"✅ Evidence-Based Coherence: Overall score {coherence_result['overall_coherence']:.3f}"
    )
    print(f"✅ FEVER Evaluation: Tested {len(evaluation_results)} sample types")
    print(
        f"✅ Multi-Evidence: Coherence improvement with more evidence: {multi_evidence_result['coherence_improvement']:+.3f}"
    )

    print("\n🎯 Key Insights:")
    print("  • FEVER adapter properly extracts claims and evidence as propositions")
    print(
        "  • Evidence-based coherence combines claim-evidence and evidence-evidence coherence"
    )
    print(
        "  • Different FEVER labels (SUPPORTS/REFUTES/NOT ENOUGH INFO) show different coherence patterns"
    )
