...
Your answer:"""
    ...
    def evaluate_dataset(
        self, samples: List[FEVERSample], method: str = "single"
    ) -> Dict[str, Any]:
        """
    ...
    mock_data = [
        ...
        },
        {
            ...
            "evidence": [
                [
                    "Earth",
                    "Earth is the third planet from the Sun and has a spherical shape",
                ]
            ],
        },
        {
            ...
            "label": "REFUTES",
            "evidence": [
                ["Shakespeare", "Shakespeare wrote approximately 37-39 plays"]
            ],
        },
        {
            ...
            "label": "SUPPORTS",
            "evidence": [
                ["Water", "At standard atmospheric pressure, water boils at 100°C"]
            ],
        },
        {
...
def compare_methods(
    evaluator: FEVEREvaluator, samples: List[FEVERSample]
) -> Dict[str, Any]:
    """
    ...
    print(
        f"Majority:  {results['majority']['accuracy']:.1%} ({majority_improvement:+.1%})"
    )
    print(
        f"Coherence: {results['coherence']['accuracy']:.1%} ({coherence_improvement:+.1%})"
    )
...
def main():
    ...
    parser.add_argument(
        "--sample-size", type=int, default=100, help="Number of samples to evaluate"
    )
    parser.add_argument(
        "--k-responses",
        type=int,
    ...
    if args.compare:
        ...
        print(
            f"  Correct: {results[args.method]['correct']}/{results[args.method]['total']}"
        )
    ...
    if args.compare:
        ...
        print(
            f"  🏆 Best method: {best_method} ({results[best_method]['accuracy']:.1%})"
        )
