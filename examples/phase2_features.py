...
def entailment_coherence_demo():
    ...
    prop_set = PropositionSet.from_qa_pair(
        question="Can penguins fly?", answer=logical_answer
    )
    ...
    contradictory_answer = (
        "The sky is blue. The sky is red. Blue and red are the same color."
    )
    prop_set2 = PropositionSet.from_qa_pair(
        question="What color is the sky?", answer=contradictory_answer
    )
...
def hybrid_coherence_demo():
    ...
    hybrid_measure = HybridCoherence(
        semantic_weight=0.6, entailment_weight=0.4, nli_model=nli_model
    )

    # Example with good semantic but poor logical coherence
    print("\n1. Mixed Coherence Example:")
    mixed_answer = (
        "Paris is beautiful. The Eiffel Tower is iconic. Cats are better than dogs."
    )
    prop_set = PropositionSet.from_qa_pair(
        question="Tell me about Paris.", answer=mixed_answer
    )
...
def adaptive_hybrid_demo():
    ...
    adaptive_measure = AdaptiveHybridCoherence(
        base_semantic_weight=0.5, base_entailment_weight=0.5, nli_model=nli_model
    )

    # Short, diverse propositions (should favor entailment)
    print("\n1. Short, Diverse Propositions:")
    short_answer = "Yes. No. Maybe."
    prop_set1 = PropositionSet.from_qa_pair(question="Is it true?", answer=short_answer)
    ...
    print(
        f"Adapted weights - Semantic: {result1.details['adapted_weights']['semantic']:.3f}, "
    ...
    prop_set2 = PropositionSet.from_qa_pair(
        question="What is machine learning?", answer=long_answer
    )
    ...
    print(
        f"Adapted weights - Semantic: {result2.details['adapted_weights']['semantic']:.3f}, "
...
def truthfulqa_benchmark_demo():
    ...
    if "coherence_contrast" in evaluation:
        print(
            f"Coherence Contrast (Correct - Incorrect): {evaluation['coherence_contrast']:.3f}"
        )
...
def selfcheckgpt_benchmark_demo():
    ...
    # Initialize evaluator
    hybrid_measure = HybridCoherence(
        semantic_weight=0.7, entailment_weight=0.3, nli_model=SimpleNLIModel()
    )
