    ...
    def _compute_similarity(self, text1: str, text2: str) -> float:
        ...
        try:
            ...
            prop1 = PropositionSet(
                propositions=[Proposition(text=text1)],
                context={"type": "response"}
            )
            prop2 = PropositionSet(
                propositions=[Proposition(text=text2)],
                context={"type": "response"}
            )
...
class CoherenceSelector:
    ...
    def _compute_coherence(self, text: str) -> float:
        ...
        try:
            ...
            # Add response
            propositions.append(
                Proposition(text=text, metadata={"type": "response"})
            )
...
class StageComparator:
    ...
    def compare_stages(
        ...
        if verbose:
            ...
            print(f"  Stage 2 (Majority Vote): {stage2_score:.1%} ({stage2_improvement:+.1%})")
            print(f"  Stage 3 (Coherence):     {stage3_score:.1%} ({stage3_improvement:+.1%})")
