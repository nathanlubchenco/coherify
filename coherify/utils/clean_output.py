...
def enable_clean_output():
    ...
    warnings.filterwarnings("ignore", category=UserWarning, message=".*return_all_scores.*")
    ...
    warnings.filterwarnings("ignore", category=UserWarning, message=".*Device set to use.*")
