...
from coherify.core.base import CoherenceResult, PropositionSet, Proposition, CoherenceMeasure
...
class CoherenceVisualizer:
    ...
    def plot_component_analysis(self, 
        ...
        if component_weights:
            contributions = [component_scores[comp] * component_weights[comp] 
    ...
    def plot_similarity_matrix(self, 
        ...
        labels = [text[:50] + "..." if len(text) > 50 else text 
                 for text in proposition_texts]
    ...
    def plot_coherence_network(self, 
...
class CoherenceAnalyzer:
    ...
    def analyze_proposition_set(self, 
        ...
        if detailed and len(prop_set) > 1:
            ...
            analysis["mean_pairwise_coherence"] = np.mean([p["coherence"] for p in pairwise_scores])
            analysis["std_pairwise_coherence"] = np.std([p["coherence"] for p in pairwise_scores])
    ...
    def compare_measures(self, 
                        ...
                        measure_names: Optional[List[str]] = None) -> Dict[str, Any]:
        """
        ...
        comparison = {
            ...
            "score_statistics": {
                ...
                "range": max([r.score for r in results]) - min([r.score for r in results])
            }
        }
        
        return comparison
    
    def analyze_benchmark_performance(self, 
        ...
        analysis = {
            ...
            "score_distribution": {
                ...
                "medium_coherence": sum(1 for s in scores if 0.3 <= s <= 0.7) / len(scores),
                ...
                try:
                    ...
                    if NETWORKX_AVAILABLE:
                        fig = self.visualizer.plot_coherence_network(
                            prop_set.propositions, similarity_matrix,
