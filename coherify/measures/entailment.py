    ...
    def compute(self, prop_set: PropositionSet) -> CoherenceResult:
        ...
        if total_pairs == 0:
            ...
            if max_possible_score == min_possible_score:
                ...
                # Scale to [0, 1] range
                score = (weighted_score - min_possible_score) / (
        ...
        return CoherenceResult(
            ...
            details={
                ...
                "contradiction_rate": (
                    contradictions / total_pairs if total_pairs > 0 else 0
                ),
...
class HuggingFaceNLIWrapper:
    ...
    def predict(self, premise: str, hypothesis: str) -> str:
        ...
        if (
            hasattr(self.pipeline.model.config, "model_type")
            and "bart" in self.pipeline.model.config.model_type
        ):
...
class SimpleNLIModel:
    ...
    def predict(self, premise: str, hypothesis: str) -> str:
        ...
        for word1, word2 in contradiction_pairs:
            if (word1 in premise and word2 in hypothesis) or (
                word2 in premise and word1 in hypothesis
            ):
