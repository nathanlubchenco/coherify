...
class HybridCoherence(CoherenceMeasure):
    ...
    def analyze_components(self, prop_set: PropositionSet) -> Dict[str, Any]:
        ...
        analysis = {
            ...
            "semantic_contribution": self.semantic_weight * details["component_scores"]["semantic"],
            "entailment_contribution": self.entailment_weight * details["component_scores"]["entailment"],
...
class AdaptiveHybridCoherence(HybridCoherence):
    ...
    def _adapt_weights(self, prop_set: PropositionSet) -> tuple[float, float]:
        ...
        vocabulary_diversity = len(set(' '.join(propositions).lower().split())) / len(' '.join(propositions).split())
