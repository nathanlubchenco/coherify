...
class CoherenceReranker:
    ...
    def rerank(self, 
               ...
               context: Optional[str] = None) -> RerankedResult:
        """
        ...
        valid_indices = [i for i, score in enumerate(coherence_scores) 
        ...
        reranked_coherence_scores = [coherence_scores[i] for i, _ in passage_score_pairs]
    ...
    def _combine_scores(self, 
                       ...
                       coherence_scores: List[float]) -> List[float]:
...
class CoherenceRAG:
    ...
    def build_context(self, 
        ...
        for i, passage in enumerate(reranked_result.passages):
            ...
            if current_length + additional_length > self.max_context_length and context_parts:
                break
    ...
    def evaluate_coherence_improvement(self,
                                     query: str,
                                     original_passages: List[PassageCandidate],
                                     reranked_result: RerankedResult) -> Dict[str, Any]:
        """
        ...
        original_prop_set = PropositionSet.from_qa_pair(
            query,
            self.passage_separator.join([p.text for p in original_top_k])
        )
        ...
        return {
            ...
            "passages_reordered": sum(
                1 for i, p in enumerate(reranked_result.passages) 
...
class BatchCoherenceReranker:
    ...
    def rerank_batch(self,
                    ...
                    top_k: Optional[int] = None,
                    contexts: Optional[List[str]] = None) -> List[RerankedResult]:
        """
