    ...
    def generate_text(
        ...
        **kwargs
        ...
        if model_to_use and model_to_use.startswith("o"):
            return self._generate_reasoning(prompt, model_to_use, temperature, max_tokens, **kwargs)
    ...
    def _generate_reasoning(
        ...
        **kwargs
        ...
        try:
            ...
            try:
                return self.generate_text(prompt, max_tokens, temperature, "gpt-4", **kwargs)
            except:
        ...
        **kwargs
        ...
        try:
            ...
            response = self.client.completions.create(
                model=model_to_use if model_to_use.startswith("text-") else "text-davinci-003",
                prompt=text,
            ...
            chat_response = self.client.chat.completions.create(
                model=model_to_use,
                messages=[
                    {"role": "system", "content": "Rate the likelihood of this text on a scale of 0.0 to 1.0. Respond only with a number."},
...
"""
    ...
    def get_available_models(self) -> List[str]:
        ...
        try:
            ...
            return [model.id for model in models.data if model.id.startswith(("gpt-", "text-", "o"))]
        except:
