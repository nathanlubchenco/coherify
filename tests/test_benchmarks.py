...
from coherify.benchmarks.adapters import (
    QABenchmarkAdapter,
...
from coherify.core.base import PropositionSet
...
class TestQABenchmarkAdapter:
    ...
    def test_convert_qa_empty_answer(self):
        ...
        qa_item = {"question": "What is the answer?", "answer": ""}
    ...
    @pytest.mark.skip(
        reason="TODO: Metadata preservation not implemented in from_qa_pair - needs core enhancement"
    )
...
class TestSummarizationBenchmarkAdapter:
    ...
    def test_convert_empty_summary(self):
        ...
        item = {"document": "Test document", "summary": ""}

        prop_set = adapter.adapt_single(item)
        assert len(prop_set.propositions) == 0

    @pytest.mark.skip(
        reason="TODO: Error handling for missing fields - needs graceful fallback implementation"
    )
...
class TestSelfCheckGPTAdapter:
    ...
    @pytest.mark.skip(
        reason="TODO: SelfCheckGPT expects multi-sample data format - test data mismatch"
    )
    ...
    @pytest.mark.skip(
        reason="TODO: Mock setup for OpenAI integration - needs proper API client mocking"
    )
    ...
    @pytest.mark.skip(
        reason="TODO: Integration test requiring proper multi-sample data and API mocking"
    )
    def test_convert_with_samples(self):
        ...
        adapter._generate_samples = Mock(
            return_value=[
                "Sample 1 response",
                "Sample 2 response",
            ]
        ...
        item = {"question": "Test question?", "answer": "Original answer"}
...
class TestTruthfulQAAdapter:
    ...
    def test_initialization_custom(self):
        """Test custom initialization."""
        adapter = TruthfulQAAdapter(evaluation_mode="mc", use_correct_answers=True)
    ...
    @pytest.mark.skip(
        reason="TODO: Category-based evaluation not fully implemented - needs proposition metadata enhancement"
    )
    ...
    def test_convert_missing_fields(self):
        ...
        item = {"question": "Test?", "best_answer": "Answer"}
